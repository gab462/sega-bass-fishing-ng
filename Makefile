CFLAGS := -std=c++23 -pedantic -Wall -Wextra -O2 -I ./external/json/single_include/ -I ./external/cpp-httplib/ -I ./external/DPP/build/install/include/ -I ./external -static-libstdc++ -static-libgcc
...
./external/DPP/build/install/lib/libdpp.so:
	cmake -S ./external/DPP/ -B ./external/DPP/build -DCMAKE_INSTALL_PREFIX=./external/DPP/build/install -DCMAKE_CXX_FLAGS="-static-libstdc++ -static-libgcc" -DCMAKE_EXE_LINKER_FLAGS="-static-libstdc++ -static-libgcc"
